...
module line(
    ...
    assign bank_en = writeback | reload ? 8'hff : bank_sel & {8{en}};
    assign bank_wen[0] = reload ? 4'hf : bank_sel[0] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[1] = reload ? 4'hf : bank_sel[1] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[2] = reload ? 4'hf : bank_sel[2] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[3] = reload ? 4'hf : bank_sel[3] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[4] = reload ? 4'hf : bank_sel[4] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[5] = reload ? 4'hf : bank_sel[5] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[6] = reload ? 4'hf : bank_sel[6] ? writeback ? 4'b0 : wen : 4'b0;
    assign bank_wen[7] = reload ? 4'hf : bank_sel[7] ? writeback ? 4'b0 : wen : 4'b0;
