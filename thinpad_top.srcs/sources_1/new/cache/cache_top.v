...
module cache_top(
    ...
    wire [`TAG_WD-1:0] tag_way0; // v + tag 
    wire [`TAG_WD-1:0] tag_way1;
    ...
    assign hit_way0 = sram_en & (~|({1'b1,tag} ^ {valid_way0[index],tag_way0}));
    assign hit_way1 = sram_en & (~|({1'b1,tag} ^ {valid_way1[index],tag_way1}));
